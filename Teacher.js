...
layui.use(['form','upload'], function(){
    $.get({
        url:"https://img.mosq.cn/assets/num.php",
        type:"POST",
...
$("#pay").click(function () {
    ...
    //     ,btnAlign: 'c'
    //     ,moveType: 1
    //     ,content: '<div class="layui-tab layui-tab-brief"><ul class="layui-tab-title"><li class="layui-this">QQ</li><li>微信</li><li>支付宝</li></ul><div class="layui-tab-content""><div class="layui-tab-item layui-show"><img src="https://www.mosq.cn/usr/uploads/sina/20191012171333.png" width="100%"></div><div class="layui-tab-item"><img src="https://www.mosq.cn/usr/uploads/sina/5cc3f8bf6d795.jpg" width="100%"></div><div class="layui-tab-item"><img src="https://www.mosq.cn/usr/uploads/sina/5cc3f8bf62f04.jpg" width="100%"></div></div></div>'
    // });
    layer.open({
        title:"捐赠(QQ 微信 支付宝)",
        type: 2,
